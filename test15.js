...
function renderEvoluciones(nodo) {
    function card(p) {
        return `
            <div class="ev-card" data-name="${p.name}">
...
// -----------------------------------------------------
// AGREGAR LISTENERS EVOLUCIONES
// -----------------------------------------------------
function agregarListenersEvoluciones() {
    document.querySelectorAll(".ev-card").forEach(card => {
        card.addEventListener("click", async () => {
            const nombre = card.getAttribute("data-name");
            await mostrarDatosDesdeEvolucion(nombre);
        });
    });
}
...
async function mostrarDatosInterna(entrada) {
    ...
    try {
        ...
        // Agregar listeners a evoluciones
        agregarListenersEvoluciones();
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Mostrar favoritos si estamos en favoritos.html
